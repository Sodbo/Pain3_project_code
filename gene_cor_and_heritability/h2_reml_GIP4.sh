...
--phenoFile=/mnt/lustre/users/DTR/k1471250/UKBB/ukbb500/v3/studies/mv/h2/mv_phen_GIPs.txt \
--phenoCol=GIP4 \
--covarFile=/mnt/lustre/users/DTR/k1471250/UKBB/ukbb500/v3/studies/mv/h2/mv_phen_GIPs.txt \
--covarCol=batch \
--covarCol=Sex \
--qCovarCol=Age \
--qCovarCol=pc{1:10} \
